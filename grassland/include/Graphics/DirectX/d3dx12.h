  ...
  explicit CD3DX12_VIEWPORT(_In_ ID3D12Resource *pResource,
    ...
    switch (Desc.Dimension) {
      ...
      case D3D12_RESOURCE_DIMENSION_TEXTURE3D:
        ...
        Width = (SubresourceWidth ? float(SubresourceWidth) : 1.0f) - topLeftX;
        Height =
            (SubresourceHeight ? float(SubresourceHeight) : 1.0f) - topLeftY;
        break;
      default:
        break;
    }
...
struct CD3DX12_RESOURCE_DESC1 : public D3D12_RESOURCE_DESC1 {
  ...
  CD3DX12_RESOURCE_DESC1(D3D12_RESOURCE_DIMENSION dimension,
                         UINT64 alignment,
                         UINT64 width,
                         UINT height,
                         UINT16 depthOrArraySize,
...
//------------------------------------------------------------------------------------------------
inline constexpr bool D3D12IsLayoutOpaque(
    D3D12_TEXTURE_LAYOUT Layout) noexcept {
...
class alignas(void *) CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT {
 ...
 public:
  ...
  CD3DX12_PIPELINE_STATE_STREAM_SUBOBJECT &operator=(
      InnerStructType const &i) noexcept {
    _Type = Type;
    _Inner = i;
    return *this;
  }
 ...
 private:
  ...
  std::list<D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION>
      m_RepointedAssociations;  // subobject type that contains pointers to
                                // other subobjects, repointed to flattened
                                // array
