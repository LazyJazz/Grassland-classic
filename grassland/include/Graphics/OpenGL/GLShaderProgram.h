...
class Shader {
 public:
  ...
  ~Shader();
  GRL_RESULT CompileShaderFromFile(const char *shader_file_path,
...
class Program {
 public:
  Program();
  ~Program();
  GRL_RESULT LinkShaders(Shader *vertex_shader,
                         Shader *fragment_shader,
                         Shader *geometry_shader = NULL);
  GRL_RESULT LinkShaders(uint32_t __vertex_shader_handle,
