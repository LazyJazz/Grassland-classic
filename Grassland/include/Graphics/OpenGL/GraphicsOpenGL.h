...
namespace Grassland
{
	...
	GRL_RESULT GRLOpenGLFunctionCall(const char* code, const char* file, int line, glFunc&& func, glArgs && ...args)
	{
...
#define GRLOpenGLCall(GLFUNC, ...) GRLOpenGLFunctionCall(#GLFUNC, __FILE__, __LINE__, GLFUNC, __VA_ARGS__)
	...
	GRLMakeObjectUUIDAssociate(GRLCOpenGLEnvironment, GRLID_COpenGLEnvironment, "698eb0b1-9767-5076-a06b-050d53290d11");
	GRLMakeObjectUUIDAssociate(GRLCOpenGLBuffer, GRLID_COpenGLBuffer, "03058c9e-40d3-5b33-b0f9-907842e56e49");
	GRLMakeObjectUUIDAssociate(GRLCOpenGLPipelineState, GRLID_COpenGLPipelineState, "432dcf2b-a630-5299-bb66-85c113bb15ae");
	GRLMakeObjectUUIDAssociate(GRLCOpenGLDepthMap, GRLID_COpenGLDepthMap, "e07c64e0-188e-5335-ba2b-944234531214");
	GRLMakeObjectUUIDAssociate(GRLCOpenGLTexture, GRLID_COpenGLTexture, "668c8ca1-18c2-54e4-a49d-f832ade20d79");
	
	class GRLCOpenGLEnvironment : public GRLIGraphicsEnvironment
	{
	public:
		GRLCOpenGLEnvironment(uint32_t width, uint32_t  height, const char * window_title);
	...
	{
	public:
		GRLCOpenGLDepthMap(uint32_t width, uint32_t height, GRLCOpenGLEnvironment* pEnvironment);
		~GRLCOpenGLDepthMap();
	...
	{
	public:
		GRLCOpenGLTexture(uint32_t width, uint32_t height, GRL_FORMAT format, GRLCOpenGLEnvironment* pEnvironment);
		~GRLCOpenGLTexture();
