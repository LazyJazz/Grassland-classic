...
namespace Grassland
{
	...
	GRLDeclareObject(CGraphics2DEnvironment, "d8342bdc-ed73-42a6-82c5-42849b9f1685");
	...
	public:
		...
		virtual GRL_RESULT DrawRectangle(float x0, float y0, float x1, float y1, float x2, float y2, GRLColor color) override;
		virtual GRL_RESULT DrawTriangle(float x0, float y0, float x1, float y1, GRLColor color) override;
		virtual GRL_RESULT PutTexture(float x0, float y0, float width, float height, GRLIGraphicsTexture* texture, float alpha = 1.0) override;
